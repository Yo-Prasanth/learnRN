...
function App() {
  ...
  const moviesg = [
    {moviename: 'kannapa', hero: 'Vishnu, ManchuMohanlal, Prabhas', poster: ''},
    {},
  ];
      ...
      <View style={styles.container}>
        ...
        <View>
          ...
          <Text style={styles.paragraph}>
            Biography: Preity Mukhundhan , an Indian film actress, has left an
            indelible mark on the Telugu and Tamil movie industry with her
            remarkable performances. Born and raised in Trichy, Tamil Nadu,
            Preity ventured into the world of cinema with her debut in the
            superhit film " Om Bheem Bush " in 2024.
          </Text>
            ...
            {movies.map((movie, index) => {
              return (
                <Text
                  ...
                  onPress={() => navigation.navigate('Details', {name: movie})}>
                  {index + 1}. {movie}
                </Text>
              );
            })}
